...
use app\admin\service\LiveRecordService;
...
class LiveRecordController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        if($this->request->isAjax()){
            ...
            //调用列表方法
            $result = LiveRecordService::RList($condition);
            $data = [];
            if(!empty($result['data'])){
                foreach ($result['data'] as $value)
                {
                    ...
                    $filed =  [
                        ...
                        'status' => LiveRecordService::statusList($value['status']),
        ...
        $status_arr = LiveRecordService::statusList();
    ...
    public function DeleteInfo()
    {
        ...
        $result = LiveRecordService::UpdateB(['id'=>$param['id']],$condition);
