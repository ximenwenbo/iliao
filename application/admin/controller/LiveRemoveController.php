...
use app\admin\service\LiveRemoveService;
use app\admin\service\UserMemberService;
use cmf\controller\AdminBaseController;

class LiveRemoveController extends AdminBaseController
{
    /**
     * 记录列表
     * @author zjy
    ...
    public function index()
    {
        ...
        if($this->request->isAjax()){
            ...
            $result = LiveRemoveService::RList($condition);
            //调用列表方法
            $data = [];
    ...
    public function DelOne(){
        ...
        $res = LiveRemoveService::DeleteInfo(['id'=>$id]);
        if($res){
