...
use app\admin\service\LiveViewerService;
use cmf\controller\AdminBaseController;

class LiveViewerController extends AdminBaseController
{
    /**
     * 管理员列表
     * @author zjy
    ...
    public function index()
    {
        ...
        if($this->request->isAjax()){
            ...
            //调用列表方法
            $result = LiveViewerService::RList($condition);
            //var_dump($result);die;
            $data = [];
            if(!empty($result['data'])){
                foreach ($result['data'] as $value)
                {
                    ...
                    $filed =  [
                        ...
                        'live_user_id' => $value['live_user_id'],
                        'status' => LiveViewerService::statusList($value['status']),
    ...
    public function DeleteInfo()
    {
        ...
        $result = LiveViewerService::UpdateB(['id'=>$param['id']],$condition);
