...
class Fun
{
     ...
     * '/' -> '_'
     * '=' -> ''
     * @param unknown $string 待编码的数据，一般为字符串
     ...
     * '_' -> '/'
     * 字符串长度%4的余数,补'='
     * @param unknown $string 待解码的字符串，一般为字符串
     ...
     * @return Decimal
     */
    public static function calc_distance($longitude1, $latitude1, $longitude2, $latitude2, $unit=2, $decimal=2)
    {
     ...
     * @return string
     */
    public static function enid10to36($int)
    {
        $dic = array(
