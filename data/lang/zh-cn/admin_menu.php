...
return array (
  ...
  'DCADMIN_ADMINAUTH_ATTESTATIONAUTHLIST' => '主播认证管理',
  'DCADMIN_ADMINAUTH_AUTHLIST' => '实名认证管理',
  'DCADMIN_ADMINCHATTASK_DEFAULT' => '运营日常',
  'DCADMIN_ADMINCHATTASK_INDEX' => '求聊任务管理',
  'DCADMIN_ADMINFEEDBACK_FEEDBACKLIST' => '用户反馈管理',
  'DCADMIN_ADMINRECHARGEORDER_INDEX' => '充值订单管理',
  'DCADMIN_ADMINRESOURCES_RESOURCESLIST' => '阿里云OSS资源管理',
  'DCADMIN_ADMINSENSITIVEWORDS_DEFAULT' => '敏感词管理',
  'DCADMIN_ADMINSENSITIVEWORDS_INDEX' => '敏感词列表',
  'DCADMIN_ADMINSETTING_DEFAULT' => '动态配置',
  'DCADMIN_ADMINSETTING_RECHARGECOIN' => '运营配置',
  'DCADMIN_ADMINSETTING_USERPROTOCOL' => '用户协议配置',
  'DCADMIN_ADMINSETTING_WEIXIN' => '第三方配置',
  'DCADMIN_ADMINTESTDATA_ADDUSER' => '造数据',
  'DCADMIN_ADMINTESTDATA_DEFAULT' => '数据配置',
  'DCADMIN_ADMINUSER_DEFAULT' => '会员管理',
  'DCADMIN_ADMINUSER_INDEX' => '用户管理',
  'DCADMIN_ADMINVIPORDER_VIPORDERLIST' => 'vip订单管理',
  'DCADMIN_ADMINWITHDRAWORDER_WITHDRAWLIST' => '用户提现管理',
