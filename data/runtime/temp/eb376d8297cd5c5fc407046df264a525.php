<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"themes/backed/admin\user_coin\index.html";i:1569392498;s:64:"E:\www\iliao\publication\themes\backed\layout\iframe\header.html";i:1569392498;}*/ ?>
<!DOCTYPE html>
...
<!-- Page JS -->
<script src="http://www.liao.com/assets/admui/js/admin/user_coin.js"></script>
<style>
    .table thead th{
        text-align: center;
    }
            ...
            <div class="panel">
                <div class="panel-body">
                    <form class="form-inline" id="logForm">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="keywords" id="keywords" placeholder="UID/手机号码" value="">
                        </div>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <table class="table table-bordered table-hover dataTable table-striped w-full" id="logList">
                    ...
                    <tfoot>
                    <tr>
                        <th colspan="6" class="text-right">消费金币总计：</th>
                        <th colspan="4"></th>
                    </tr>
                    </tfoot>
                </table>
...
<script>
    ...
    function detailsPopup(id) {
        layer.open({
            ...
            shade: 0.2,
            area: ['100%','100%'],
            content: "http://www.liao.com/admin/user_coin/ViewDetails/id/"+id,
        });
    }
</script>
</body>
