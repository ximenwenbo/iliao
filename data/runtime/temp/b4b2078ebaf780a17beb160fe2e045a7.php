<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"themes/backed/admin\recharge_order\index.html";i:1569392498;s:64:"E:\www\iliao\publication\themes\backed\layout\iframe\header.html";i:1569392498;}*/ ?>
<!DOCTYPE html>
...
<!-- Page JS -->
<script src="http://www.liao.com/assets/admui/js/admin/recharge_order.js"></script>
<style>
    .table thead th{
        text-align: center;
    }
...
<script>
    ...
    function AuthPopup(obj) {
        layer.open({
            ...
            shade: 0.2,
            area: ['100%','100%'],
            content: "http://www.liao.com/admin/chat_task/ToExamine?id="+obj,
        });
    }
</script>
</body>
