<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"themes/backed/admin\withdraw_order\index.html";i:1569392498;s:64:"E:\www\iliao\publication\themes\backed\layout\iframe\header.html";i:1569392498;}*/ ?>
<!DOCTYPE html>
...
<!-- Page JS -->
<script src="http://www.liao.com/assets/admui/js/admin/withdraw_order.js"></script>
<style>
    .table thead th{
        text-align: center;
    }
                    ...
                    <form class="form-inline" id="logForm">
                        ...
                        <div class="form-group row">
                            <div class="col-xl-12 col-md-3 col-form-label">
                                <select class="form-control col-xl-12" name="type" data-plugin="select2">
                                    <option value="" >选择类型</option>
                                    <?php if(isset($typeList) && !empty($typeList)){ foreach($typeList as $key=>$item){ ?>
                                    <option value="<?php echo $key; ?>" <?php echo $key==1?'selected':''?> ><?php echo $item; ?></option>
                                    <?php } } ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-xl-12 col-md-3 col-form-label">
                                <select class="form-control col-xl-12" name="status" data-plugin="select2">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="keywords" id="keywords" placeholder="订单号/提现账户" value="">
                        </div>
        ...
        <div class="panel">
            <div class="panel-body">
                <table class="table table-bordered table-hover dataTable table-striped w-full" id="logList">
                    ...
                    <tfoot>
                    <tr>
                        <th colspan="6" class="text-right">总计：</th>
                        <th colspan="6"></th>
                    </tr>
                    </tfoot>
                </table>
...
<script>
    ...
    //打开编辑页面
    function AuthPopup(obj) {
        layer.open({
            type: 2,    //0（信息框，默认）1（页面层）2（iframe层）3（加载层）4（tips层）
            title: '编辑敏感词', //弹出框的标题
            shade: 0.2,
            area: ['100%','100%'],
            content: "http://www.liao.com/admin/withdraw_order/ToExamine?id="+obj,
        });
    }
</script>
</body>
