<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:36:"themes/backed/admin\index\index.html";i:1571130914;s:63:"E:\www\iliao\publication\themes\backed\layout\index\layout.html";i:1569392498;s:63:"E:\www\iliao\publication\themes\backed\layout\index\header.html";i:1569392498;s:63:"E:\www\iliao\publication\themes\backed\layout\index\footer.html";i:1569392498;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <script src="http://www.liao.com/assets/admui/vendor/layer/layer.min.js"></script>
    ...
    <!-- 布局 -->
    <script src="http://www.liao.com/assets/admui/themes/base/js/site.js"></script>
    <script src="http://www.liao.com/assets/admui/themes/base/js/sections/content-tabs.js"></script>
    ...
    <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-inverse" id="admui-siteNavbar"
        ...
        <div class="navbar-header">
            ...
            <div class="navbar-brand navbar-brand-center site-gridmenu-toggle " data-toggle="gridmenu">
                <a href="http://www.liao.com" >
                    <img class="navbar-brand-logo d-sm-block d-lg-block d-none navbar-logo"
                         src="http://www.liao.com/assets/admui/images/admin_index_logo.png" title="Xchat">
                </a>

                <!--<img class="navbar-brand-logo d-sm-block d-lg-block d-none navbar-logo"
                     src="http://www.liao.com/assets/admui/images/logo-white.svg" title="Xchat">
                <img class="navbar-brand-logo d-sm-none navbar-logo-mini" src="http://www.liao.com/assets/admui/images/logo-white-min.svg"
                     title="Xchat">-->
            </div>
        </div>
                        ...
                        <a class="nav-link navbar-avatar" data-toggle="dropdown" href="javascript:void (0);" aria-expanded="false"
                           ...
                           role="button">
                            <span class="avatar avatar-online">
                                <img src="http://www.liao.com/assets/admui/images/avatar.svg" alt="...">
                                <i></i>
                            </span>
                        </a>
...
<footer class="site-footer">
    <div class="site-footer-right">
        直播管理后台 - 当前版本：v1.0.0
        <a class="ml-5" data-toggle="tooltip" title="购买或升级" href="http://www.liao.com" target="_blank">
...
<!-- 消息通知 -->
<!--<script src="http://www.liao.com/assets/admui/js/notify-msg.js"></script>-->
</body>
</html>
