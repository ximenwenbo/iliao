<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:57:"E:\www\iliao\publication/themes/backed/tpl\error_jump.tpl";i:1569392498;}*/ ?>
    ...
    <div class="page page-full vertical-align text-center animation-fade page-error">
        <div class="page-content vertical-align-middle">
            <!--<div class="brand text-center">
                <img class="" src="http://www.liao.com/assets/admui/images/logo.svg" height="50" alt="Admui" style="padding-bottom: 0.5rem;margin-bottom: 0.3rem">
            </div>*}-->
            <header>
