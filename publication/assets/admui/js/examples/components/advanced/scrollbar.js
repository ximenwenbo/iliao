...
(function(document, window, $) {
    ...
    $(function() {
        ...
        // 滚动到顶部
        $(document).on('click', '.api-scroll-top', function() {
            $('#exampleScollableApi').mCustomScrollbar('scrollTo', 'top');
        });

        // 滚动到某个位置
        $(document).on('click', '.api-scroll-to', function() {
            var to = $(this).data('to');
            $('#exampleScollableApi').mCustomScrollbar('scrollTo', to);
        });
        ...
        $(document).on('click', '.api-scroll-by', function() {
            ...
            $('#exampleScrollbarApi').mCustomScrollbar('scrollTo', type + '=' + to);
        });
    });
