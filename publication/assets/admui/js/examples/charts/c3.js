...
(function (document, window, $) {
    ...
    var chart6 = function () {
        var bar_chart = c3.generate({
            ...
            color: {
                pattern: [$.getColor("red", 400), $.getColor("blue-grey", 400), $.getColor("blue-grey", 200)]
            },
            grid: {
                y: {
                    show: true
    ...
    var chart7 = function () {
        var stacked_bar_chart = c3.generate({
            ...
            color: {
                pattern: [$.getColor("purple", 500), $.getColor("blue-grey", 300), $.getColor("purple", 500), $.getColor("light-green", 500)]
            },
            bar: {
                width: {
                    max: 45
    ...
    var chart8 = function () {
        c3.generate({
            ...
            color: {
                pattern: [$.getColor("blue-grey", 400), $.getColor("blue-grey", 200), $.getColor("yellow", 600), $.getColor("purple", 600), $.getColor("red", 400), $.getColor("green", 600)]
            },
            grid: {
                x: {
                    show: false
