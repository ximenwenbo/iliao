    ...
    var morris = {
        ...
        mLine: function () { // 曲线图示例
            Morris.Line({
                ...
                gridtextSize: 14,
                lineWidth: 1,
                lineColors: [$.getColor("green", 600), $.getColor("purple", 600)]
            });
        },
        mArea: function () { // 区域图
            Morris.Area({
                ...
                lineWidth: 1,
                fillOpacity: 0.1,
                lineColors: [$.getColor("purple", 600), $.getColor("green", 600)]
            });
        },
        mBar: function () { // 柱状图
            Morris.Bar({
                ...
                gridtextSize: 14,
                resize: true,
                barColors: [$.getColor("red", 500), $.getColor("blue-grey", 300)]
            });
        },
        mDonut: function () { // 环形图
            Morris.Donut({
                ...
                // barSizeRatio: 0.35,
                resize: true,
                colors: [$.getColor("red", 500), $.getColor("purple", 500), $.getColor("blue-grey", 300)]
            });
        }
    };
