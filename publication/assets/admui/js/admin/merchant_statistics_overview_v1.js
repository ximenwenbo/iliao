...
(function (window, document, $) {
    ...
    var indexV1 = {
        ...
        linePoint1: function () { // Widget Linepoint
            ...
            $.ajax({
                type: 'POST',
                url: "/admin/merchant_statistics_overview/todayIncome",
                data: {},
                async:false,
                dataType: "json",
                success: function(data){
                     a = data.data.recharge;
                     b = data.data.vip;
                },
            ...
            new Chartist.Line("#widgetLinepoint1 .ct-chart", {
                labels: ['1', '2', '3', '4', '5', '6', '7', '8'],
                series: [
                    b
                ]
        ...
        overallViews: function () { // Widget Overall Views
            ...
            $.ajax({
                type: 'POST',
                url: "/admin/merchant_statistics_overview/consumeCount",
                data: {},
                async:false,
                dataType: "json",
                success: function(data){
