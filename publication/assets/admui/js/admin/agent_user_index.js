            ...
            switch(_index){
                case 0:
                    layer.open({
                        ...
                        shade: 0.2,
                        area: ['100%','100%'],
                        content: "/admin/agent_user/edit/id/"+id,
                    });
                    break;
                case 1:
                    layer.open({
                        ...
                        shade: 0.2,
                        area: ['100%','100%'],
                        content: "/admin/agent_user/adminAccount/id/"+id,
                    });
                    break;
                case 2:
                    layer.open({
                        ...
                        shade: 0.2,
                        area: ['100%','100%'],
                        content: "/admin/agent_user/DividedSetting/id/"+id,
                    });
                    break;
                case 3:
                    layer.confirm('确定要删除代理商?',{btn: ['确定', '取消'], title: "警告"},function () {
                        $.ajax({
                            type: 'POST',
                            url: "/admin/agent_user/delete",
                            data: {
                                id: id,
                            },
                            dataType: "json",
